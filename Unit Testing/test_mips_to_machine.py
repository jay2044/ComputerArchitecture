...
r_type_test_examples = [
    ...
    ["div $t1, $t2", "00000001001010100000000000011010"],  # div
    ["divu $t1, $t2", "00000001001010100000000000011011"],  # divu
    ["mfhi $t1", "00000000000000000100100000010000"],  # mfhi
    ["mflo $t1", "00000000000000000100100000010010"],  # mflo
    ["mfc0 $t1, $0", "01000000000000000100100000000000"],  # mfc0, note: coprocessor 0 instruction
    ["mult $t1, $t2", "00000001001010100000000000011000"],  # mult
    ["multu $t1, $t2", "00000001001010100000000000011001"],  # multu
    ["sra $t1, $t2, 2", "00000000000010100100100010000011"]  # sra
]
...
i_type_test_examples = [
    ...
    ["beq $t1, $t2, 22", "00010001001010100000000000010110"],  # beq
    ["bne $t1, $t2, 22", "00010101001010100000000000010110"],  # bne
    ...
    ["ori $t1, $t2, 255", "00110101010010010000000011111111"],  # ori
...
j_type_test_examples = [
    ["j 0x00400000", "00001000010000000000000000000000"],  # j
    ["jal 0x00400000", "00001100010000000000000000000000"],  # jal
    ["jr $ra", "00000011111000000000000000001000"]  # jr
]
